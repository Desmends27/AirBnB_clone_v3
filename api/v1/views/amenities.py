...
@app_views.route("/<amenity_id>", methods=["GET"], strict_slashes=False)
...
@app_views.route("/<amenity_id>", methods=["DELETE"], strict_slashes=False)
...
@app_views.route("/<amenity_id>", methods=["PUT"], strict_slashes=False)
